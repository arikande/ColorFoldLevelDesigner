...
public class SetLevelIdToDialog extends JDialog {
	...
	public SetLevelIdToDialog(Frame frame) {
		super(frame);
		setModal(true);
	...
	public void setLevelIdSpinnerValues(int minimum, int value, int maximum) {
		getLevelIdSpinnerModel().setMinimum(minimum);
		getLevelIdSpinnerModel().setValue(value);
		getLevelIdSpinnerModel().setMaximum(maximum);
	}
