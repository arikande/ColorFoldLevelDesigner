...
public class FindLevelSolutionDialog extends JDialog {
	...
	private JButton addSolutionToLevelButton;
	...
	public void setWriteSolutionToFileButtonAction(Action action) {
		getAddSolutionToLevelButton().setAction(action);
	}
	...
	public void setAddSolutionToLevelButtonVisible(boolean visible) {
		getAddSolutionToLevelButton().setVisible(visible);
	}
	...
	private JPanel getPageEndPanel() {
		if (pageEndPanel == null) {
			...
			pageEndPanel.add(getAddSolutionToLevelButton());
	...
	private JButton getAddSolutionToLevelButton() {
		if (addSolutionToLevelButton == null) {
			addSolutionToLevelButton = new JButton();
		}
		return addSolutionToLevelButton;
	}
