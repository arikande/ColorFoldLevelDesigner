...
public class LevelDesignerFrame extends JFrame {
    ...
    private JMenuItem openSolutionFilesMenuItem;
    ...
    public void setOpenSolutionFilesMenuItemAction(Action action) {
	getOpenSolutionFilesMenuItem().setAction(action);
    }
	...
	if (solutionMenu == null) {
	    ...
	    solutionMenu.add(getOpenSolutionFilesMenuItem());
	    solutionMenu.add(getTestSolutionsMenuItem());
	}
	return solutionMenu;
    }

    private JMenuItem getOpenSolutionFilesMenuItem() {
	if (openSolutionFilesMenuItem == null) {
	    openSolutionFilesMenuItem = new JMenuItem();
	}
	return openSolutionFilesMenuItem;
    }
