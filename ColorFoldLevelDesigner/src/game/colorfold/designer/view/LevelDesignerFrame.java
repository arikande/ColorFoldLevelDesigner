...
public class LevelDesignerFrame extends JFrame {
    ...
    private JMenuItem exportLevelFilesMenuItem;
    ...
    public void setExportLevelFilesMenuItemAction(Action action) {
	getExportLevelFilesMenuItem().setAction(action);
    }
	...
	if (fileMenu == null) {
	    ...
	    fileMenu.add(getExportLevelFilesMenuItem());
    ...
    private JMenuItem getExportLevelFilesMenuItem() {
	if (exportLevelFilesMenuItem == null) {
	    exportLevelFilesMenuItem = new JMenuItem();
	}
	return exportLevelFilesMenuItem;
    }
