...
public class LevelFileXMLConverter {
	...
	public void writeToFile(ColorFoldLevel colorFoldLevel) {
		...
		fileContent.append(LevelDesignerConstants.TAB);
		...
		while (validCoordinatesIterator.hasNext()) {
			...
			fileContent.append(LevelDesignerConstants.TAB + LevelDesignerConstants.TAB);
		...
		while (coordinatesIterator.hasNext()) {
			...
			fileContent.append(LevelDesignerConstants.TAB + LevelDesignerConstants.TAB + LevelDesignerConstants.TAB);
			fileContent.append(convertCoordinateToString(coordinate));
			fileContent.append(System.getProperty("line.separator"));
		...
		if (colorFoldLevelSolution != null) {
			...
			fileContent.append(LevelDesignerConstants.TAB);
			fileContent.append("<solution_moves>");
			fileContent.append(System.getProperty("line.separator"));
			...
			while (movesIterator.hasNext()) {
				...
				fileContent.append(colorFoldMoveXMLConverter.toXML(colorFoldMove));
			}
