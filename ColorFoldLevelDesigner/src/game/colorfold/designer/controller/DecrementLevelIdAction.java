...
public class DecrementLevelIdAction extends AbstractAction {

    private LevelDesignerController levelDesignerController;

    public DecrementLevelIdAction(LevelDesignerController levelDesignerController) {
	super("Decrement level id");
